...
BladeEngine::Camera::Camera(glm::vec2 dimensions, glm::vec2 position, float rotation, float nearPlane,float farPlane,BladeEngine::CameraType cameraType)
{
...
BladeEngine::Camera::Camera(glm::vec2 dimensions, glm::vec3 position, glm::vec3 rotation,float nearPlane,float farPlane, BladeEngine::CameraType cameraType)
{
    this->dimensions = dimensions;
...
float BladeEngine::Camera::Aspect()
{
    return (dimensions.x/dimensions.y);
}

float BladeEngine::Camera::GetHeight()
{
    return dimensions.y;
}

float BladeEngine::Camera::GetWidth()
{
    return dimensions.x;
}

glm::mat4 BladeEngine::Camera::GetViewMatrix()
{
    return viewMatrix;
}
