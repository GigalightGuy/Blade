...
void BladeEngine::Graphics::Vulkan::VulkanDevice::Dispose()
{
...
BladeEngine::Graphics::Vulkan::QuerySwapChainSupport(VkPhysicalDevice device,
...
bool VulkanDevice::CheckDeviceExtensionSupport(
    VkPhysicalDevice physicalDevice, std::vector<const char *> extensions) {
